...
Example 3:  
Text: "Regression analysis revealed that higher nutrient levels increased plant growth in the Amazon rainforest during the wet season."  
Entities: {{"Regression analysis": "Method", "higher nutrient levels increased plant growth": "Causalstatements", "Amazon rainforest": "Locationofstudy", "wet season": "Timeperiodofstudy"}}

Example 4:  
Text: "Based on our findings, we suggest increasing shade cover to improve moss survival in alpine tundra habitats."  
Entities: {{"we suggest increasing shade cover to improve moss survival": "Reccomendationsandsuggestions", "alpine tundra habitats": "Ecosystem", "moss": "Focalpoint"}}
...
if __name__=='__main__':
    ...
    OUT_DIR   = 'output/few_shot_variant_1'
