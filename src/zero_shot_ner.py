# qwen_ie_chat_format.py – Phase 2 + Batch JSON postprocessing to WebAnno TSV with span matching
# Now processes all .txt × .tsv pairs, naming outputs “<txt_stem>__<tsv_stem>_annotations.tsv”
